        ...
        public static IEnumerable<Client> Clients =>
            new Client[]
            {
                ...
                new Client
                {
                    ...
                    AllowedScopes = { "Catalog_FullPermision","PhotoStock_FullPermision", "Gateway_FullPermision", IdentityServerConstants.LocalApi.ScopeName }
                },
                ...
                new Client
                {
                    ...
                    AllowedScopes = { "Catalog_FullPermision", "Basket_FullPermision", "Discount_FullPermision", "Order_FullPermision", "Payment_FullPermision", "Gateway_FullPermision", IdentityServerConstants.StandardScopes.Email,IdentityServerConstants.StandardScopes.OpenId,IdentityServerConstants.StandardScopes.Profile,IdentityServerConstants.StandardScopes.OfflineAccess, IdentityServerConstants.LocalApi.ScopeName },
